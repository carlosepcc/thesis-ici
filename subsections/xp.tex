...
Una \ac{hu} se descompone en varias tareas de ingeniería, que describen las actividades que se realizarón en cada \ac{hu}, asó mismo las tareas de ingeniería se vinculan más al desarrollador, ya que permite tener un acercamiento con el código~\citep{VALLADAREZ2016}.. 
...
\begin{itemize}
	...
	\item \textbf{Diseño}: Especificación de cómo debe ser el Diseño final de la aplicación, haciendo ónfasis en que un Diseño sencillo es más fácil de implementar que uno complejo.
