...
A continuación se muestra un listado \ac{hu} obtenidas así como su prioridad dentro del negocio determinada por en conjunto con el equipo de desarrollo :
...
\end{enumerate}
A continuación se presentan las \ac{hu} con mayor prioridad dentro del negocio, determinadas por el cliente en conjunto con el equipo de desarrollo. El resto se podrán encontrar en la sección de apéndices \ref{app:hu}: Historias de Usuario.
...
% Para crear un caso disciplinario basta con asignar una comisión a una denuncia pendiente:
% \begin{userstory}
