...
\end{enumerate}
A continuación se presentan las \ac{hu} con mayor prioridad dentro del negocio, determinadas por el cliente e conjunto con el equipo de desarrollo. El resto se podrán encontrar en la sección de apéndices \ref{app:hu}: Historias de Usuario.
